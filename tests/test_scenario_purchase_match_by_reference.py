...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        with Transaction().start(
            ...
            self.assertEqual(DbPurchase.search_count([]), 1)

            # (b) No existing purchase matches the supplier's reference: a
